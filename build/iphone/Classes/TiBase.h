...
// in simulator we redefine to format for monsto Developer console
...
{\
	NSString * exceptionName = [@"org.monsto." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.monsto";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImonstoNativeItemNone = -1, 
	UImonstoNativeItemSpinner = -2,
	UImonstoNativeItemProgressBar = -3,
	
	UImonstoNativeItemSlider = -4,
	UImonstoNativeItemSwitch = -5,
	UImonstoNativeItemMultiButton = -6,
	UImonstoNativeItemSegmented = -7,
	
	UImonstoNativeItemTextView = -8,
	UImonstoNativeItemTextField = -9,
	UImonstoNativeItemSearchBar = -10,
	
	UImonstoNativeItemPicker = -11,
	UImonstoNativeItemDatePicker = -12,
	
	UImonstoNativeItemInfoLight = -13,
	UImonstoNativeItemInfoDark = -14,
	
	UImonstoNativeItemDisclosure = -15,
	
	UImonstoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all monsto instances of
